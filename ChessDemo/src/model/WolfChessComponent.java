...
public class WolfChessComponent extends ChessComponent {
    ...
    public void loadResource() throws IOException {
        if (WHITE == null) {
            WHITE = ImageIO.read(new File("./images/BWolf.png"));
        }

        if (BLACK == null) {
            BLACK = ImageIO.read(new File("./images/RWolf.png"));
        }
    }
    ...
    private void initiateWolfImage(ChessColor color) {
        try {
            loadResource();
    ...
    public WolfChessComponent(ChessboardPoint chessboardPoint, Point location, ChessColor color, ClickController listener, int size) {
        super(chessboardPoint, location, color, listener, size);
        initiateWolfImage(color);
    }
