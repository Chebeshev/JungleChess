...
public class DogChessComponent extends ChessComponent {
    ...
    public void loadResource() throws IOException {
        if (WHITE == null) {
            WHITE = ImageIO.read(new File("./images/BDog.png"));
        }

        if (BLACK == null) {
            BLACK = ImageIO.read(new File("./images/RDog.png"));
        }
    }
    ...
    private void initiateDogImage(ChessColor color) {
        try {
            loadResource();
    ...
    public DogChessComponent(ChessboardPoint chessboardPoint, Point location, ChessColor color, ClickController listener, int size) {
        super(chessboardPoint, location, color, listener, size);
        initiateDogImage(color);
    }
