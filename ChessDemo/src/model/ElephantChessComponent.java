...
public class ElephantChessComponent extends ChessComponent {
    ...
    public void loadResource() throws IOException {
        if (WHITE == null) {
            WHITE = ImageIO.read(new File("./images/BElephant.png"));
        }

        if (BLACK == null) {
            BLACK = ImageIO.read(new File("./images/RElephant.png"));
        }
    }
    ...
    public ElephantChessComponent(ChessboardPoint chessboardPoint, Point location, ChessColor color, ClickController listener, int size) {
        super(chessboardPoint, location, color, listener, size);
        initiateElephantImage(color);
    }
